...
public class UserDaoImpl extends AbstractDao implements UserDao {
    ...
    public User create(User user) {
        ...
        try {
            ...
            throw new ProcessingDataException("Can't create user with ID " + user.getId(), e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public List<User> getAll() {
        try (Session session = factory.openSession()) {
            ...
            throw new ProcessingDataException("Can't get all users", e);
        }
    }
    ...
    public void remove(User user) {
        ...
        try {
            ...
            throw new ProcessingDataException("Can't remove user with ID " + user.getId(), e);
        } finally {
            if (session != null) {
                session.close();
            }
