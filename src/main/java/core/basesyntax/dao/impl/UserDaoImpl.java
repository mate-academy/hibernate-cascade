...
public class UserDaoImpl extends AbstractDao implements UserDao {
    ...
    public User create(User entity) {
        ...
        try {
            ...
            throw new RuntimeException("Can't saave " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public User get(Long id) {
        try (Session session = factory.openSession();) {
            ...
            throw new RuntimeException("Something wrong within get User", e);
        }
    }
    ...
    public void remove(User entity) {
        ...
        try {
            ...
            throw new RuntimeException("Can't save " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
