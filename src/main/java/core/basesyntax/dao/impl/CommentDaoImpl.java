...
public class CommentDaoImpl extends AbstractDao implements CommentDao {
    ...
    public Comment create(Comment comment) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't insert comment " + comment + " to table.", e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Comment get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new DataProcessingException("Can't get comment for id " + id, e);
        }
    }
