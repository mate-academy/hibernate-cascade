...
public class CommentDaoImpl extends AbstractDao implements CommentDao {
    ...
    public Comment create(Comment entity) {
        ...
        try {
            ...
            throw new RuntimeException("Could not create comment : "
                    + entity + " in DB", e);
        } finally {
            if (session != null) {
                session.close();
    ...
    public Comment get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Could not get comment with id : "
                    + id + " from DB", e);
        }
    }
    ...
    public void remove(Comment entity) {
        ...
        try {
            ...
            throw new RuntimeException("Could not remove comment : "
                    + entity + " from DB", e);
        } finally {
            if (session != null) {
                session.close();
