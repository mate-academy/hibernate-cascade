...
public class CommentDaoImpl extends AbstractDao implements CommentDao {
    ...
    public Comment create(Comment entity) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot create comment in DB. Comment: " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Comment get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Cannot get comment from DB by id: " + id, e);
        }
    }
    ...
    public void remove(Comment entity) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot remove comment from DB. Comment: " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
