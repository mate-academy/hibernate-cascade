...
public class CommentDaoImpl extends AbstractDao implements CommentDao {
    ...
    public Comment get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Can't get comment to DB by id " + id, e);
        }
    }
    ...
    public List<Comment> getAll() {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Cant get comments to DB", e);
        }
    }
    ...
    public void remove(Comment entity) {
        ...
        try {
            ...
            throw new RuntimeException("Can't remove comment " + entity + " to DB", e);
        } finally {
            if (session != null) {
                session.close();
            }
