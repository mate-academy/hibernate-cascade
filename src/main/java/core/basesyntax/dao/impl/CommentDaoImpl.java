...
public class CommentDaoImpl extends AbstractDao implements CommentDao {
    ...
    public Comment create(Comment entity) {
        ...
        try {
            ...
            throw new RuntimeException("Couldn't create a comment " + entity);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Comment get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Couldn't get a comment with id " + id);
        }
    }
    ...
    public List<Comment> getAll() {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Couldn't get all comment");
        }
    }
