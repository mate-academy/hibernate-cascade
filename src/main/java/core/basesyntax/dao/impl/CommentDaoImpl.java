...
public class CommentDaoImpl extends AbstractDao implements CommentDao {
    ...
    public Comment create(Comment entity) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't create comment record "
                    + entity + " in database", e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public List<Comment> getAll() {
        try (Session session = factory.openSession()) {
            ...
            throw new DataProcessingException("Can't get comments from database", e);
        }
    }
