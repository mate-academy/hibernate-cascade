...
public class MessageDaoImpl extends AbstractDao implements MessageDao {
    ...
    public Message create(Message message) {
        ...
        try {
            ...
            throw new ProcessingDataException("Can't create message with ID "
                    + message.getId(), e);
        } finally {
            if (session != null) {
                session.close();
    ...
    public List<Message> getAll() {
        try (Session session = factory.openSession()) {
            ...
            throw new ProcessingDataException("Can't get all messages", e);
        }
    }
    ...
    public void remove(Message message) {
        ...
        try {
            ...
            throw new ProcessingDataException("Can't remove message with ID " + message.getId(), e);
        } finally {
            if (session != null) {
                session.close();
            }
