...
public class MessageDaoImpl extends AbstractDao implements MessageDao {
    ...
    public Message create(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException(String.format(
                    "Can`t create message %s and add it to DB", entity), e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Message get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException(String.format(
                    "Can`t get message with id %s from DB", id), e);
        }
    }
    ...
    public void remove(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("Can`t remove message %s from DB", entity), e);
        } finally {
            if (session != null) {
                session.close();
            }
