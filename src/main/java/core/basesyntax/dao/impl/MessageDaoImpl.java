...
public class MessageDaoImpl extends AbstractDao implements MessageDao {
    ...
    public Message create(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot create message in DB. Message: " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Message get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Cannot get message from DB by id: " + id, e);
        }
    }
    ...
    public void remove(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot remove message from DB. Message: " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
