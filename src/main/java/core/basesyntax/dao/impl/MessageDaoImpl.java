...
public class MessageDaoImpl extends AbstractDao implements MessageDao {
    ...
    public Message create(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot create a message to DB", e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Message get(Long id) {
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException("Cannot get a message by id: " + id, e);
        }
    }
    ...
    public void remove(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot remove a message from DB", e);
        } finally {
            if (session != null) {
                session.close();
            }
