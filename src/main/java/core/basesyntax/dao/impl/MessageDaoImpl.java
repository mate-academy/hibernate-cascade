...
public class MessageDaoImpl extends AbstractDao implements MessageDao {
    ...
    public Message create(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException(
                    String.format("Can't add message %s to DB", entity), e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Message get(Long id) {
        ...
        try (Session session = factory.openSession()) {
            ...
            throw new RuntimeException(
                    String.format("Can't get message id = %s from DB", id), e);
        }
        return message;
    }
    ...
    public void remove(Message entity) {
        ...
        try {
            ...
            throw new RuntimeException(
                    String.format("Can't remove message %s from DB", entity), e);
        } finally {
            if (session != null) {
                session.close();
            }
