...
public class SmileDaoImpl extends AbstractDao implements SmileDao {
    ...
    public Smile create(Smile entity) {
        ...
        try {
            ...
            throw new RuntimeException("Can't create new smile in DB " + entity, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public List<Smile> getAll() {
        try (Session session = factory.openSession()) {
            Query<Smile> allSmile = session.createQuery("FROM Smile", Smile.class);
            return allSmile.getResultList();
        } catch (Exception e) {
